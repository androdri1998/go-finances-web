...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      const newbalance: Balance = {} as Balance;
      Object.keys(response.data.balance).map(key => {
        Object.assign(newbalance, {
          [key]: formatValue(response.data.balance[key]),
        });
        return true;
      });
